"""
KT Parameter dataset loader.

Load Kamlet-Taft (KT) parameters  dataset
KT parameters quantify the acidity and basicity of a molecules (alpha and beta repsectively)
These parameters are experimentally measured using Nuclear magnetic resonance (NMR) spectroscopy\
The dataset loaded here has been hand curated from several papers included below
  Random splitting is recommended for this dataset.
  The raw data csv file contains columns below:
  - "cid" - Pubchem CID of molecules
  - "csmiles" - canonical SMILES representation of the molecular structure
  - "alpha" - KT parameter (quantifies acidity)
  - "beta" - KT parameter (quantifies basicity)
  References
  ----------
...
mydataset_splitters = ['index','random','scaffold','butina','stratified']
